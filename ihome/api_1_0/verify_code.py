...
#GET /api/vi.0/sms_code/<mobile>?image_
...
def get_sms_code(mobile):
    ...
    # 与用户填写的值进行对比
    if real_image_code.lower() !=image_code.lower().encode(encoding='utf-8'):
        print(real_image_code.lower(),type(real_image_code.lower()))
        print(image_code.lower(), type(image_code.lower()))
